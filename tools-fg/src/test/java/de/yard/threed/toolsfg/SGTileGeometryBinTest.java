...
public class SGTileGeometryBinTest {
    ...
    /**
     * High level Test. SGMaterialTest should run without failures.
     */
    @Test
    public void testRefBtgSurfaceGeometryWithMaterial() {

        SGMaterialLib matlib = FlightGear.loadMatlib(true);
        if (matlib == null) {

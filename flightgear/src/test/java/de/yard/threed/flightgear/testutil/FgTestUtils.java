...
public class FgTestUtils {
    ...
    public static Bundle buildDummyBundleModel777() {
        Bundle my777 = new Bundle("My-777", new String[]{"Models/777-200.ac"}, "??");
    ...
    public static Bundle buildDummyBundleModelbasic() {
        Bundle fgdatabasicmodel = new Bundle("fgdatabasicmodel", new String[]{"AI/Aircraft/737/Models/B737-300.ac","AI/Aircraft/737/737-AirBerlin.xml"}, "??");

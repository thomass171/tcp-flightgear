...
public class BundleTest {
    ...
    public void testResolve() {
        my777 = FgTestUtils.buildDummyBundleModel777();
        fgdatabasicmodel = FgTestUtils.buildDummyBundleModelbasic();

        BundleResource br = new BundleResource(new ResourcePath("AI/Aircraft/737"), "737-AirBerlin.xml");
        br.bundle = fgdatabasicmodel;
        BundleResource result = FgBundleHelper.findPath("Models/B737-300.ac", br);

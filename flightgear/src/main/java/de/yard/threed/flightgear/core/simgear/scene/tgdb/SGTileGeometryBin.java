...
public class SGTileGeometryBin extends SGTriangleBin {
   ...
   /* static void
     ...
     * Aus der allen Trianglemaps ein Mesh erstellen.
     * 12.12.17: Aufgeteilt um das erstellen der Geo im preprocess verwenden zu koennen.
     * 18.04.2019: ppfile enthält selber kein Material. Ich betrachte matcache mal als "optional". Wenns null ist,
     * erfolgt wireframe.
     */
        ...
        for (int k=0;k<ppfile.getObjectCount();k++) {
            ...
            if (matcache != null) {
                ...
                if (ppfile.materials.size() == 0 && matcache != null) {
                    ...
                    int textureindex = 0;
                    mat = (sgmat != null) ? (sgmat.get_one_effect(textureindex).getMaterialDefinition()) : null;
                } else {

...
////////////////////////////////////////////////////////////////////////
    ...
    LogClassMapping log_class_mappings [] = {
            ...
            LogClassMapping(SG_VIEW, "viewer"),
 ...
 * /
// XXX Making the result buffer be global isType a band-aid that hopefully
 ...
 * /
    ...
    setLoggingPriority (const char * p)
    {
        ...
        SG_LOG(SG_GENERAL, SG_DEBUG, "Logging priority isType " << getLoggingPriority());
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    FGProperties::getLongitudeString ()
    {
        ...
        if (format == 0) {
            ...
            // preventing getSecond values of 60.
    ...
    FGProperties::bind ()
    {
        ...
        _usec = fgGetNode("/sim/time/utc/getSecond", true);
        ...
        _rsec = fgGetNode("/sim/time/real/getSecond", true);
...
*/
    ...
    public static boolean fgLoadProps(BundleResource/*String*/ path, SGPropertyNode props) {
        return fgLoadProps(path, props, true, 0);
    }

    /**
     * 28.6.17: Seit Bundle brauchts das Flag in_root eigentlich nicht mehr. Naja, oder wegen fullpath?
     * 
     */
    public static boolean fgLoadProps(BundleResource/*String*/ path, SGPropertyNode props, boolean in_fg_root, int default_mode) {
        String fullpath;
     /*28.6.17   if (in_fg_root) {
            SGPath loadpath = new SGPath(FGGlobals.globals.get_fg_root());
...
////////////////////////////////////////////////////////////////////////
    ...
    public static SGPropertyNode fgGetNode(String path) {
        return FGGlobals.globals.get_props().getNode(path, false);
    }

    public static SGPropertyNode fgGetNode(String path, boolean create) {
        return FGGlobals.globals.get_props().getNode(path, create);
    }

    SGPropertyNode fgGetNode(String path, int index, boolean create) {
        return FGGlobals.globals.get_props().getNode(path, index, create);
    }

    boolean fgHasNode(String path) {
        return (fgGetNode(path, false) != null);
    }
    ...
    */
    ...
    public static boolean fgGetBool(String name) {
        return fgGetBool(name, false);
    }

    public static boolean fgGetBool(String name, boolean defaultValue) {
        return FGGlobals.globals.get_props().getBoolValue(name, defaultValue);
    }

    public static int fgGetInt(String name, int defaultValue) {
        return FGGlobals.globals.get_props().getIntValue(name, defaultValue);
    }

    public static long fgGetLong(String name, long defaultValue) {
        return FGGlobals.globals.get_props().getLongValue(name, defaultValue);
    }

    public static float fgGetFloat(String name, float defaultValue) {
        return FGGlobals.globals.get_props().getFloatValue(name, defaultValue);
    }

    public static double fgGetDouble(String name) {
        return fgGetDouble(name, 0);
    }
    
    public static double fgGetDouble(String name, double defaultValue) {
        return FGGlobals.globals.get_props().getDoubleValue(name, defaultValue);
    }

    public static String fgGetString(String name) {
        // 11.7.16: Default ist "", nicht null
        return FGGlobals.globals.get_props().getStringValue(name, "");

    }

    public static String fgGetString(String name, String defaultValue) {
        return FGGlobals.globals.get_props().getStringValue(name, defaultValue);

    }

    public static boolean
    fgSetBool(String name, boolean val) {
        return FGGlobals.globals.get_props().setBoolValue(name, val);
    }

    public static boolean
    fgSetInt(String name, int val) {
        return FGGlobals.globals.get_props().setIntValue(name, val);
    }

    public static boolean
    fgSetLong(String name, long val) {
        return FGGlobals.globals.get_props().setLongValue(name, val);
    }

    public static boolean
    fgSetFloat(String name, float val) {
        return FGGlobals.globals.get_props().setFloatValue(name, val);
    }

    public static boolean
    fgSetDouble(String name, double val) {
        return FGGlobals.globals.get_props().setDoubleValue(name, val);
    }

    public static boolean fgSetString(String name, String val) {
        return FGGlobals.globals.get_props().setStringValue(name, val);
    }
/*
    void

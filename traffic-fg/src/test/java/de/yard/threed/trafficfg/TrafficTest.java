...
public class TrafficTest {
    ...
    public void testEddkPlatzrunde() throws Exception {
        ...
        SystemManager.putDataProvider(SystemManager.DATAPROVIDERELEVATION, StaticElevationProvider.buildForStaticAltitude(27));
        ...
        StaticElevationProvider tep = (StaticElevationProvider) SystemManager.getDataProvider(SystemManager.DATAPROVIDERELEVATION);
        ...
        tep = (StaticElevationProvider) SystemManager.getDataProvider(SystemManager.DATAPROVIDERELEVATION);
        assertNotNull( tep,"elevation provider");
        Assertions.assertEquals( 27, tep.getAltitude(), 0.5,"altitude from elevation provider");
